...
Output: pratham-prepped.png (grayscale), consumed by make_ascii_svg.py.
...
INP = sys.argv[1] if len(sys.argv) > 1 else os.path.join(HERE, "..", "pratham-photo.jpeg")
OUT = sys.argv[2] if len(sys.argv) > 2 else os.path.join(HERE, "..", "pratham-prepped.png")
